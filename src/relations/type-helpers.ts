...
type ValidRelationFieldType<
  TRelation extends "one" | "many" | "ref" | undefined,
...
type _RelationPopulationOptions<
  TDbRelations extends Record<string, AnyRelations>,
...
export type Population<
  ...
  TName extends keyof TDbRelations,
> = {
  [K in keyof TDbRelations[TName]]?:
    | _RelationPopulationOptions<TDbRelations, TDbRelations[TName][K]>
    | true;
};

type WithRelationPopulation<
  T,
  TPopulationOptions extends
    | PopulationOptions<any, any, any>
    | true
    | undefined,
