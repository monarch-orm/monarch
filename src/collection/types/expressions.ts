...
export type MiscellaneousExpressionOperator = Rand | SampleRate;
...
export type ArrayExpressionOperatorReturningNumber = IndexOfArray | Size;

export type ArrayExpressionOperatorReturningObject = ArrayToObject;

export type ArrayExpressionOperatorReturningBoolean = In | IsArray;

export type BooleanExpressionOperator = And | Or | Not;
...
export type ConditionalExpressionOperator = Cond | IfNull | Switch;
...
export type StringExpressionOperatorReturningArray = RegexFindAll | Split;
...
export type VariableExpressionOperatorReturningAny = Let;
...
export type TextExpressionOperator = Meta;
...
export type WindowOperatorReturningAny = First | Last | Shift;

export type WindowOperatorReturningArray = AddToSet | Push;
...
export type TypeExpressionOperatorReturningNumber =
  | Convert<"double" | 1 | "int" | 16 | "long" | 18 | "decimal" | 19>
  | ToDecimal
  | ToDouble
  | ToInt
  | ToLong;
...
export type DataSizeOperator = BinarySize | BsonSize;

export type DataSizeOperatorReturningNumber = BinarySize | BsonSize;

export type CustomAggregationExpressionOperator = Accumulator | Function;

export type CustomAggregationExpressionOperatorReturningAny = Function;
...
export type DateExpressionOperatorReturningObject = DateToParts;
...
export type DateExpressionOperatorReturningString = DateToString;
