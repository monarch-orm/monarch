import type { _InferTypeObjectInput, _InferTypeObjectOutput } from "../types/type-helpers";
import type {
  IdFirst,
  Merge,
  Pretty,
...
export type SchemaInputWithId<T extends AnySchema> = WithRequiredId<_InferTypeObjectInput<InferSchemaTypes<T>>>;

export type InferSchemaInput<T extends AnySchema> = Pretty<WithOptionalId<_InferTypeObjectInput<InferSchemaTypes<T>>>>;
export type _InferSchemaData<T extends AnySchema> = WithRequiredObjectId<_InferTypeObjectOutput<InferSchemaTypes<T>>>;
